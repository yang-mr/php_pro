...
<div class="my_infomation">
                ...
                <div class="base_infomation" id="w_base_infomation">
                    ...
                    <form id="form_base" name="form_base" action="{{ route('edit_msg') }}" method="post" onsubmit="return check_post();">
                        ...
                        所在地区：</span></td>
                                    <td>
                                        <!--如果手机没有验证-->
                                        <select name="work_location" style="color:#666;" id="profile_location" class="select1" onchange="build_second(this.value,'profile_sublocation',LOK);
            select_changed();"></select>&nbsp;&nbsp;
                                        <select style="color:#666;" name="work_sublocation" id="profile_sublocation" class="select2" onChange="document.getElementById('change_area_div').style.display='';
            select_changed()">
                                        </select>
                      ...
                      <!--                   <a href="javascript:;" class="tips_link" id="modify_location_tag" onmousedown="send_jy_pv2('|1027534_6|');" onclick="show_modity_profile('location');">修改</a> -->
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name="nation" id="nation" onChange="select_changed();">
                                            <option value="0">--请选择--</option>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <select id="income" name="income" style="color:#666;" onChange="validate('income', this.value)">
                                            ...
                                            <option label="50000元以上" value="6">50000元以上</option>
                                        </select>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select id="car" name="car" onChange="select_changed();">
                                            <option value="0">--请选择--</option>
    ...
    @endsection @section('right_content')
