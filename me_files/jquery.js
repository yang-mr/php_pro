...
(function($) {
	...
	$.fn.lightBox = function(settings) {
		...
		settings = jQuery.extend({
			...
			imageLoading:			'http://images1.jyimg.com/w4/usercp/i/lightbox-ico-loading.gif',		// (string) Path and the name of the loading icon
			imageBtnPrev:			'http://images1.jyimg.com/w4/usercp/i/lightbox-btn-prev.gif',			// (string) Path and the name of the prev button image
			imageBtnNext:			'http://images1.jyimg.com/w4/usercp/i/lightbox-btn-next.gif',			// (string) Path and the name of the next button image
			imageBtnClose:			'http://images1.jyimg.com/w4/usercp/i/lightbox-btn-close.gif',		// (string) Path and the name of the close btn
			imageBlank:				'http://images1.jyimg.com/w4/usercp/i/lightbox-blank.gif',			// (string) Path and the name of a blank image (one pixel)
